...
namespace PrivateHospital.Controllers
{
    public class AppointmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientId,DoctorId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatientId,DoctorId")] Appointment appointment)
        {
